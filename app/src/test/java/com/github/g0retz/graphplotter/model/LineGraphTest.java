...
public class LineGraphTest {
  ...
  public void testConstructorWithoutNameAndColor() {
    ...
    assertEquals(0, graph.minValue);
    assertEquals(3, graph.maxValue);
  }
  ...
  public void testConstructorWithoutColor() {
    ...
    assertEquals(10, graph.minValue);
    assertEquals(13, graph.maxValue);
  }
  ...
  public void testConstructorWithoutName() {
    ...
    assertEquals(20, graph.minValue);
    assertEquals(23, graph.maxValue);
  }
  ...
  public void testConstructor() {
    ...
    assertEquals(30, graph.minValue);
    assertEquals(33, graph.maxValue);
  }
  ...
  public void testHasValuesInTheAreaRange() {
    ...
    assertEquals(-1983, graph.minValue);
    assertEquals(1809, graph.maxValue);
    // Area is lefter
  ...
  public void testValuesInTheExactAreaRange() {
    ...
    // (1551 - 809)x + 809 = 1500
    assertArrayEquals(new Float[] { 2f + ((1500f - 809) / (1551 - 809)), 1500f, 0f },
        forwards.next());
    // (107 - 1809)x + 1809 = 1500
    assertArrayEquals(new Float[] { 4f + ((1500f - 1809) / (107 - 1809)), 1500f, 1f },
        forwards.next());
    assertArrayEquals(new Float[] { 5f, 107f, 0f }, forwards.next());
    // (1737 - 107)x + 107 = 1500
    assertArrayEquals(new Float[] { 5f + ((1500f - 107) / (1737 - 107)), 1500f, 0f },
        forwards.next());
    // (-1663 - 1737)x + 1737 = 1500
    assertArrayEquals(new Float[] { 6f + ((1500f - 1737) / (-1663 - 1737)), 1500f, 1f },
        forwards.next());
    // (-1663 - 1737)x + 1737 = -1500
    assertArrayEquals(new Float[] { 6f + ((-1500f - 1737) / (-1663 - 1737)), -1500f, 0f },
        forwards.next());
    // (-1471 + 1663)x - 1663 = -1500
    assertArrayEquals(new Float[] { 7f + ((-1500f + 1663) / (-1471 + 1663)), -1500f, 1f },
        forwards.next());
    ...
    // (1580 - 964)x + 964 = 1500
    assertArrayEquals(new Float[] { 10f + ((1500f - 964) / (1580 - 964)), 1500f, 0f },
        forwards.next());
    // (-1983 - 1580)x + 1580 = 1500
    assertArrayEquals(new Float[] { 11f + ((1500f - 1580) / (-1983 - 1580)), 1500f, 1f },
        forwards.next());
    // (-1983 - 1580)x + 1580 = -1500
    assertArrayEquals(new Float[] { 11f + ((-1500f - 1580) / (-1983 - 1580)), -1499.9995f, 0f },
        forwards.next());
    // (1349 + 1983)x -1983 = -1500
    assertArrayEquals(new Float[] { 12f + ((-1500f + 1983) / (1349 + 1983)), -1500f, 1f },
        forwards.next());
  ...
  public void testValuesInTheExactToInsideAreaRange() {
    ...
    assertArrayEquals(new Float[] { 17f, -683f, 0f }, forwards.next());
    // (-273 + 683)x - 683 = ?
    assertArrayEquals(new Float[] { 17.3f, ((-273 + 683) * (17.3f - 17) - 683), 0f },
        forwards.next());
    assertFalse(forwards.hasNext());
  }
